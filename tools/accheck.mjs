...
const NEW_DATE = "2026-07-02"; // must differ from either file's current Last updated so the bump is a real edit (advanced past 2026-07-01 — OP-074 data files reach 2026-07-01)
let failed = 0;
